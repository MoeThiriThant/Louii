...
;(function () {
  ...
  // Custom function to return the correct path based on the piece
  config.pieceTheme = function(piece) {
    // Map the piece shorthand to the full color name and piece type
    const pieceMap = {
    ...
    // Check if the shorthand piece name exists in the map
    if (pieceMap[piece]) {
      return `pieces/${pieceMap[piece]}.png`;  // Return the full path with color and piece type
    }

    // Return a default if the piece name is not found
